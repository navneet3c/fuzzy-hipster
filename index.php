...
<thead><tr id="scorestable1"><th><img src="images/plank.png" alt=" "><span>Department</span></th>
<th><img src="images/plank.png" alt=" "><span>Rank</span></th>
<th><img src="images/plank.png" alt=" "><span><a href="assets/scores_desc.php?e=culturals" class="lightbox" title="Details of Cultural Events Scores">Culturals</a></span></th>
<th><img src="images/plank.png" alt=" "><span><a href="assets/scores_desc.php?e=english_lits" class="lightbox" title="Details of English Literature Events Scores">English Lits</a></span></th>
<th><img src="images/plank.png" alt=" "><span><a href="assets/scores_desc.php?e=hindi_lits" class="lightbox" title="Details of Hindi Literature Events Scores">Hindi Lits</a></span></th>
<th><img src="images/plank.png" alt=" "><span><a href="assets/scores_desc.php?e=tamil_lits" class="lightbox" title="Details of Tamil Literature Events Scores">Tamil Lits</a></span></th>
<th><img src="images/plank.png" alt=" "><span><a href="assets/scores_desc.php?e=arts" class="lightbox" title="Details of Arts Events Scores">Arts</a></span></th>
<th><img src="images/plank.png" alt=" "><span><a href="assets/scores_desc.php?e=design" class="lightbox" title="Details of Design Events Scores">Design</a></span></th>
<th><img src="images/plank.png" alt=" "><span>Total</span></th></tr></thead>
<tbody>
<?php
$res=run_query("SELECT `a`.*,(SELECT `culturals`+`english`+`hindi`+`tamil`+`arts`+`design` AS `total` FROM `score_main` `b` WHERE `a`.`branchid`=`b`.`branchid`) 'total' FROM `score_main` `a` ORDER BY `total` DESC,`name` ASC ;",$c);
$i=0;$j=1;
$score=-1;
while($row=mysql_fetch_assoc($res)){
	$j++;
	if($score!=$row['total'])
		$i++;
	$score=$row['total'];
	echo "<tr id='scorestable{$j}'>
	<td class='branchnametd'><img src='images/plank.png' alt=''><span><a href='assets/scores_desc.php?b={$row['branchid']}' class='lightbox' title='Details for Scores of {$row['initial']}'>{$row['initial']}</a></span></td>
	<td><img src='images/plank.png' alt=''><span>$i</span></td>
	<td><img src='images/plank.png' alt=''><span><a href='assets/scores_desc.php?b={$row['branchid']}&e=culturals' class='lightbox' title='Details for Scores of {$row['initial']} in Cultural Events'>".floatval($row['culturals'])."</span></a></td>
	<td><img src='images/plank.png' alt=''><span><a href='assets/scores_desc.php?b={$row['branchid']}&e=english_lits' class='lightbox' title='Details for Scores of {$row['initial']} in English Literature Events'>".floatval($row['english'])."</span></a></td>
	<td><img src='images/plank.png' alt=''><span><a href='assets/scores_desc.php?b={$row['branchid']}&e=hindi_lits' class='lightbox' title='Details for Scores of {$row['initial']} in Hindi Literature Events'>".floatval($row['hindi'])."</span></a></td>
	<td><img src='images/plank.png' alt=''><span><a href='assets/scores_desc.php?b={$row['branchid']}&e=tamil_lits' class='lightbox' title='Details for Scores of {$row['initial']} in Tamil Literature Events'>".floatval($row['tamil'])."</span></a></td>
	<td><img src='images/plank.png' alt=''><span><a href='assets/scores_desc.php?b={$row['branchid']}&e=arts' class='lightbox' title='Details for Scores of {$row['initial']} in Arts Events'>".floatval($row['arts'])."</span></a></td>
	<td><img src='images/plank.png' alt=''><span><a href='assets/scores_desc.php?b={$row['branchid']}&e=design' class='lightbox' title='Details for Scores of {$row['initial']} in Design Events'>".floatval($row['design'])."</span></a></td>
	<td class='totalscoretd'><img src='images/plank.png' alt=''><span>".floatval($row['total'])."</span></td>
	</tr>";
}
?>
<tbody></table>
